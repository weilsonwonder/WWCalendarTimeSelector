        ...
        if detail.type == .month {
            ...
            for i in 1...7 {
                if date.weekday == i {
                    ...
                    let str = NSAttributedString(string: "1", attributes: [NSFontAttributeName: font, NSForegroundColorAttributeName: dayFontColor, NSParagraphStyleAttributeName: paragraph])
