...
open class WWCalendarTimeSelector: UIViewController, UITableViewDelegate, UITableViewDataSource, WWCalendarRowProtocol, WWClockProtocol {
  ...
  ///
  open static func instantiate() -> WWCalendarTimeSelector { //WWCalendarTimeSelector
  ...
  fileprivate func updateDate() {
    ...
    let attrText = NSAttributedString(string: timeText, attributes: [NSAttributedStringKey.font: optionSelectorPanelFontTime, NSAttributedStringKey.foregroundColor: optionSelectorPanelFontColorTime, NSAttributedStringKey.paragraphStyle: paragraph])
